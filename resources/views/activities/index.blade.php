        ...
        <main class="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">{{ $total }} assignment{{ $total !== 1 ? 's' : '' }}</p>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 px-4 py-3 flex flex-col sm:flex-row gap-3">
                <div class="relative flex-1">
                    ...
                    <input id="searchInput" type="text" placeholder="Search by caregiver or patient…" oninput="filterTable()"
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                @if ($total > 0)
                        ...
                        <table class="w-full text-sm">
                            <thead>
                                <tr class="border-b border-gray-100 bg-gray-50/60">
                                    ...
                                    <th class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wide px-6 py-3">Date</th>
                                    <th class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wide px-6 py-3">Time</th>
                                    ...
                                    <tr class="hover:bg-gray-50/50 transition-colors activity-row"
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-2.5">
                                                <div class="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center shrink-0">
                                                    <span class="text-xs font-semibold text-red-500">{{ $ptInitial }}</span>
                                                </div>
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <button onclick="confirmDelete('{{ $docID }}', '{{ addslashes($caregiverName) }}', '{{ addslashes($patientName) }}')"
                    ...
                    <div class="px-6 py-3 border-t border-gray-50">
                        <p class="text-xs text-gray-400">Showing <span id="shownCount">{{ $total }}</span> of {{ $total }} schedules</p>
                    </div>
                @else
...
@if (session('success'))
    <script>
        Swal.fire({ position: 'top-end', icon: 'success', title: '{{ session('success') }}', showConfirmButton: false, timer: 1800, toast: true });
    </script>
@endif
</body>
</html>
