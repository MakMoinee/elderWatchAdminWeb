...
<head>
    ...
    <title>Add Guardian — ElderWatch</title>
        ...
        <div class="flex-1 flex flex-col min-h-screen lg:ml-60 overflow-hidden" style="margin-left:200px;"
            ...
            <header class="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-6 shrink-0 z-20">
                ...
                <div class="flex items-center gap-3 flex-1">
                    ...
                    <div>
                        <h1 class="text-sm font-semibold text-gray-900">Add Guardian</h1>
                        <p class="text-xs text-gray-400">Register a new guardian account</p>
                    </div>
                </div>
            ...
            <main class="flex-1 overflow-y-auto p-6">
                <form action="{{ route('guardians.store') }}" method="POST" class="max-w-2xl mx-auto space-y-5">
                    @csrf
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100">
                            ...
                            <p class="text-xs text-gray-400 mt-0.5">Guardian's full name and contact details</p>
                        </div>
                        <div class="px-6 py-5 space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5">Phone
                                        Number</label>
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5">Address</label>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100">
                            <h2 class="text-sm font-semibold text-gray-900">Account Credentials</h2>
                            <p class="text-xs text-gray-400 mt-0.5">Used to log into the ElderWatch mobile app</p>
                        </div>
                        <div class="px-6 py-5 space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <button type="button" onclick="togglePass('passField','eye1')"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="password" name="password_confirmation" id="passConfField"
                                            placeholder="Repeat password"
                                            class="w-full px-3.5 py-2.5 pr-10 text-sm border border-gray-200 rounded-xl
                                                   focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                                        <button type="button" onclick="togglePass('passConfField','eye2')"
                                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
