            ...
            <main class="flex-1 overflow-y-auto p-6">
                <div class="max-w-2xl mx-auto space-y-5">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 p-5 flex items-center gap-4">
                        ...
                        <span
                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-50 text-purple-600">
                            userType: 3
                        </span>
                    </div>
                    ...
                    <form action="{{ route('guardians.update', $userID) }}" method="POST" class="space-y-5">
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                            ...
                            <div class="px-6 py-5 space-y-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5">Middle
                                            Name</label>
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                            <button type="button" onclick="togglePasswordSection()"
                                ...
                                <svg id="pwChevron" class="w-4 h-4 text-gray-400 transition-transform" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            <div id="passwordSection"
                                class="hidden px-6 pb-5 pt-1 border-t border-gray-100 space-y-4">
                                <p class="text-xs text-gray-400">Leave blank to keep the current password.</p>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        <label
                                            class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5">New
                                            Password</label>
                                        <div class="relative">
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5">Confirm
                                            Password</label>
                                        <div class="relative">
