            ...
            <main class="flex-1 overflow-y-auto p-6 space-y-5">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 px-4 py-3 flex flex-col sm:flex-row gap-3">
                    ...
                    <div class="text-sm text-gray-400 flex items-center shrink-0">
                        <span
                            id="visibleCount">{{ $totalGuardians }}</span>&nbsp;result{{ $totalGuardians !== 1 ? 's' : '' }}
                    </div>
                </div>
                    ...
                    @if ($totalGuardians > 0)
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    @foreach ($guardians as $guardian)
                                        ...
                                        <tr class="hover:bg-gray-50/50 transition-colors guardian-row"
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-sm font-semibold text-purple-600">{{ $gInitial }}</span>
                                                    </div>
                                                    <div>
                                                        <p class="font-medium text-gray-900">{{ $gDisplay ?: '—' }}
                                                        </p>
                                            ...
                                            {{-- Phone --}}
                                            <td class="px-6 py-4 text-gray-600">{{ $gPhone !== '—' ? $gPhone : '—' }}
                                            </td>
                                            ...
                                            <td class="px-6 py-4">
                                                @if ($gDate)
                                                    <span
                                                        class="inline-block text-xs font-medium px-2.5 py-1 rounded-full bg-purple-50 text-purple-600">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <div class="flex items-center justify-end gap-2">
                                                    ...
                                                    <button
                                                        onclick="confirmDelete('{{ $gDocId }}', '{{ addslashes($gDisplay) }}')"
                        ...
                        <div class="px-6 py-3 border-t border-gray-50">
                            <p class="text-xs text-gray-400">
                                Showing <span id="shownCount">{{ $totalGuardians }}</span> of {{ $totalGuardians }}
                                guardians
                            </p>
                        </div>
                    @else
