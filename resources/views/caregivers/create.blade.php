...
<head>
    ...
    <title>Add Caregiver — ElderWatch</title>
        ...
        <div class="flex-1 flex flex-col min-h-screen lg:ml-60 overflow-hidden" style="margin-left:200px;"
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <nav class="flex items-center gap-2 text-xs text-gray-400 mb-6">
                    ...
                    <span class="text-gray-600 font-medium">Add New</span>
                </nav>
                ...
                <div class="max-w-2xl">
                    ...
                    @if ($errors->any())
                        <div
                            class="mb-6 bg-red-50 border border-red-100 rounded-xl px-4 py-3 flex items-start gap-3">
                    ...
                    <form method="POST" action="{{ route('caregivers.store') }}">
                        @csrf
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 p-6 mb-5">
                            ...
                            <textarea name="address" rows="2" placeholder="Street, Barangay, City, Province"
                                class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50
                                   focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition resize-none">{{ old('address') }}</textarea>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="password" name="password" id="passwordField"
                                            ...
                                            class="w-full px-3 py-2.5 pr-10 text-sm border rounded-xl bg-gray-50
                                               focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition
                                               @error('password') border-red-300 @else border-gray-200 @enderror">
                                        <button type="button"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="password" name="password_confirmation"
                                            id="passwordConfirmField" placeholder="Re-enter password"
                                            class="w-full px-3 py-2.5 pr-10 text-sm border border-gray-200 rounded-xl bg-gray-50
                                               focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition">
                                        <button type="button"
                                            onclick="togglePassword('passwordConfirmField', 'eyeIcon2')"
                                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
                                            <svg id="eyeIcon2" class="w-4 h-4" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
