...
<body class="bg-white text-gray-900 antialiased">
    ...
    <section class="pt-32 pb-20 px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            <span
                class="inline-flex items-center gap-2 bg-blue-50 text-blue-700 text-xs font-semibold px-3 py-1 rounded-full mb-6">
                ...
                @php
                    $features = [
                        [
                            ...
                            'desc' =>
                                'Access a complete overview of all incident and monitoring reports across every patient and caregiver in the system.',
                        ],
                        [
                            ...
                            'desc' =>
                                'Register and manage caregiver accounts, assign patients, and review their activity monitoring and incident reports.',
                        ],
                        [
                            'icon' =>
                            ...
                            'desc' =>
                                'Manage guardian profiles and their access to caregiver monitoring reports and patient status information.',
                        ],
                        [
                            'icon' =>
                            ...
                            'title' => 'Patient Info',
                            'desc' =>
                                'Maintain detailed patient records and link them to the YOLO-powered body posture detection system for continuous monitoring.',
                        ],
                        [
                            'icon' =>
                            ...
                            'desc' =>
                                'Register and manage CCTV devices used by caregivers for real-time patient surveillance and incident detection.',
                        ],
                        [
                            'icon' =>
                            ...
                            'desc' =>
                                'Caregivers receive instant alert notifications for real-time detection incidents. Guardians receive SMS notifications automatically.',
                        ],
                    ];
                    $colors = [
                ...
                @foreach ($features as $f)
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-md transition-shadow">
                        <div class="w-10 h-10 rounded-xl {{ $c['bg'] }} flex items-center justify-center mb-4">
                            <svg class="w-5 h-5 {{ $c['icon'] }}" fill="none" viewBox="0 0 24 24"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                @php
                    $steps = [
                        [
                            'num' => '01',
                            'title' => 'Patient Monitored',
                            'desc' =>
                                'CCTV cameras capture body movements using the YOLO detection algorithm around the clock.',
                        ],
                        [
                            'num' => '02',
                            'title' => 'Incident Detected',
                            'desc' =>
                                'Machine learning models analyse posture and movement to identify falls or unusual behaviour.',
                        ],
                        [
                            'num' => '03',
                            'title' => 'Caregiver Alerted',
                            'desc' => 'Real-time alert notifications are pushed to the assigned caregiver immediately.',
                        ],
                        [
                            'num' => '04',
                            'title' => 'Guardian Notified',
                            'desc' =>
                                'SMS notifications are automatically sent to the patient\'s guardian with incident details.',
                        ],
                    ];
                @endphp
                @foreach ($steps as $s)
                    <div class="text-center">
                        <div
                            class="w-12 h-12 rounded-full bg-blue-600 text-white font-bold text-sm flex items-center justify-center mx-auto mb-4">
                            {{ $s['num'] }}
                        </div>
        ...
        <div class="max-w-3xl mx-auto text-center">
            <div class="bg-blue-600 rounded-3xl px-8 py-16">
                ...
                <p class="text-blue-100 mb-8 leading-relaxed">
                    Log in to the admin portal to manage caregivers, guardians, patients, and view all monitoring
                    reports.
                </p>
                <a href="{{ route('login') }}"
    ...
    <footer class="border-t border-gray-100 py-8 px-6 lg:px-8">
        <div
            class="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-400">
